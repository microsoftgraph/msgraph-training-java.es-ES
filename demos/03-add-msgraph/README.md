...
- El [Kit de desarrollo de Java se (JDK)](https://java.com/en/download/faq/develop.xml) y [Maven](https://maven.apache.org/) instalado en el equipo de desarrollo. Si no tiene el JDK o el Maven, visite los vínculos anteriores para las opciones de descarga. (**Nota:** este tutorial se ha escrito con OpenJDK versión 12.0.1 y Maven 3.6.1. Los pasos de esta guía pueden funcionar con otras versiones, pero no se han probado.
